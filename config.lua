...
-- xanCT outgoing damage/healing options
	...
	["showhots"] = true,		-- show periodic healing effects in xanCT healing frame.
...
-- appearence
	...
	["font_1"] = "Interface\\Addons\\xanCT\\HOOGE.TTF",	-- incoming damage justify
	["font_2"] = "Interface\\Addons\\xanCT\\HOOGE.TTF",	-- incoming healing justify
	["font_3"] = "Interface\\Addons\\xanCT\\HOOGE.TTF",	-- various messages justify (mana, rage, auras, etc)
	["font_4"] = "Fonts\\ARIALN.ttf",					-- boss alerts and or emotes
	["font_5"] = "Interface\\Addons\\xanCT\\HOOGE.TTF",	-- outgoing damage/healing justify
	--font size
	...
	--damage font
	["damagefont"] = "Interface\\Addons\\xanCT\\HOOGE.TTF",	 -- "Fonts\\FRIZQT__.ttf" is default WoW damage font
	--["damagefontsize"] = "auto",	-- size of xanCT damage font. use "auto" to set it automatically depending on icon size, or use own value, 16 for example. if it's set to number value icons will change size.
	["damagefontsize"] = 16,	-- size of xanCT damage font. use "auto" to set it automatically depending on icon size, or use own value, 16 for example. if it's set to number value icons will change size.
...
-- class modules and goodies
	...
	["mergehealspam"] = true,	-- merges multiple incoming heal spam on the player to reduce the spam caused by periodic incoming heals for frame xanCT2
	["mergeaoespamtime"] = 4,	-- time in seconds aoe spell will be merged into single message. minimum is 1.
	["mergeincominghealspamtime"] = 4,	-- time in seconds to merge incoming heal numbers this is xanCT2 frame not the Event Frame xanCT5
